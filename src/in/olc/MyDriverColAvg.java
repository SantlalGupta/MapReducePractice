...
public class MyDriverColAvg {

	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
      String input="hdfs://localhost:9000/user/hduser/columnAverage_input";
      String output="hdfs://localhost:9000/user/hduser/columnAverage_output";
      ...
      job.setMapperClass(MyMapperColAvg.class);
      job.setReducerClass(MyReducerColAvg.class);
      job.setJarByClass(MyDriverColAvg.class);
      /*
